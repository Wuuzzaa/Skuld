    ...
    d.iv_rank,
    d.iv_percentile,
    (current_setting('app.time_travel_date', true)::date - g.from_date) AS days_of_options_data_history,
    ...
    (current_setting('app.time_travel_date', true)::date - h.from_date) AS days_of_stock_prices_history,
    i."asOfDate",
    i."periodType",
    i."currencyCode",
    i."AccountsPayable",
   ...
   FROM ((((((((("StockPricesYahooHistoryTimeTravel" a
     LEFT JOIN "EarningDatesHistoryTimeTravel" b ON ((a.symbol = b.symbol)))
     ...
     LEFT JOIN "StockVolatilityHistoryTimeTravel" e ON ((a.symbol = e.symbol)))
     LEFT JOIN "DividendDataHistoryTimeTravel" f ON ((a.symbol = f.symbol)))
     ...
     LEFT JOIN "FundamentalDataHistoryTimeTravel" i ON ((a.symbol = i.symbol)))
     LEFT JOIN "TechnicalIndicatorsCalculatedHistoryTimeTravel" j ON ((a.symbol = j.symbol)));;
