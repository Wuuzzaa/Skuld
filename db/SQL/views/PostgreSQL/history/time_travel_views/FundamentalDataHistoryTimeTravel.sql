        ...
        CREATE OR REPLACE VIEW
             "FundamentalDataHistoryTimeTravel" AS
         SELECT a.symbol,
    a."asOfDate",
    a."periodType",
    a."currencyCode",
   ...
   FROM ("FundamentalDataYahooHistoryTimeTravel" a
     LEFT JOIN "StockAssetProfilesYahooHistoryTimeTravel" c ON ((a.symbol = c.symbol)));;
