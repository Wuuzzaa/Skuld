...
SELECT
	...
	a."Summary_navPrice",
	-- FundamentalDataDividendRadarHistory
	CASE
		WHEN b.symbol IS NOT NULL THEN TRUE
		ELSE FALSE
	END as has_fundamental_data_dividend_radar,
	b."Company",
	b."FV",
	b."Sector",
	b."No-Years",
	...
	b."Classification"
FROM
	FundamentalDataYahooHistory as a
	LEFT OUTER JOIN FundamentalDataDividendRadarHistory AS b ON a.symbol = b.symbol
	AND a.date = b.date;