...
const navItems = [
  { href: '/dividend-screener', label: 'Dividend Screener', icon: Award, color: 'text-amber-600' },
  { href: '/dividend-portfolio', label: 'Portfolio Builder', icon: Wallet, color: 'text-emerald-600' },
  { href: '/spreads', label: 'Spreads', icon: TrendingUp, color: 'text-emerald-600' },
  { href: '/earnings-put-screener', label: 'Earnings Puts', icon: TrendingUp, color: 'text-orange-600' },
  { href: '/iron-condors', label: 'Iron Condors', icon: Layers, color: 'text-blue-600' },
  { href: '/covered-calls', label: 'Covered Calls', icon: Shield, color: 'text-lime-600' },
  { href: '/covered-call-scanner', label: 'CC Scanner', icon: Target, color: 'text-lime-600' },
  ...
  { href: '/multifactor-swingtrading', label: 'Multifactor', icon: Zap, color: 'text-amber-600' },
  { href: '/rsl-momentum', label: 'RSL Momentum', icon: BarChart3, color: 'text-green-600' },
  { href: '/correlation', label: 'Correlation', icon: Grid3X3, color: 'text-violet-600' },
  { href: '/watchlist', label: 'Watchlist', icon: Eye, color: 'text-rose-600' },
  { href: '/universe', label: 'Universe', icon: Globe, color: 'text-teal-600' },
  { href: '/symbols', label: 'Symbols', icon: Search, color: 'text-indigo-600' },
  { href: '/data-logs', label: 'Data Logs', icon: Database, color: 'text-gray-600' },
  { href: '/admin', label: 'Admin', icon: Settings, color: 'text-red-600' },
];
