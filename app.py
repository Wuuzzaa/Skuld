...
portfolio_hedge_calculator = st.Page("pages/portfolio_hedge_calculator.py", title="Portfolio Hedge Calculator")
trade_journal = st.Page("pages/trade_journal.py", title="Trade Journal")
