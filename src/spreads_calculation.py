...
def get_sell_options(df, delta_target):
    """
...
def get_buy_options(df, sell_puts, sell_calls, spread_width):
    """
...
def get_spreads(df, expiration_date, delta_target, spread_width):
    ...
    # sell options
    sell_puts, sell_calls = get_sell_options(df, delta_target)

    # add buy options
    puts, calls = get_buy_options(df, sell_puts, sell_calls, spread_width)
    print()
